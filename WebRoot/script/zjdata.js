 ...
 //修改数据
	   function upda(obj){
		   ...
		   layer.open({
			    ...
			    +"</div><form name='xgdata'  action='updatas.action' method='post' ><input type='text' value="+updata+" id='textid' class='form-control' ></form><div class='container'><button class='btn btn-success' onclick='upSubmit("+updid2+")'><span class='glyphicon glyphicon-save'></span>&nbsp;&nbsp;保存修改</button></div>",
